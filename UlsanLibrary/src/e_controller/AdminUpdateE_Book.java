...
@WebServlet("/admin/admin_EBook/AdminUpdateE.do")
@MultipartConfig(
		fileSizeThreshold = 0,
		location = "C:\\JSP\\UlsanLibrary\\WebContent\\upload" //저장될 경로
)
public class AdminUpdateE_Book extends HttpServlet {
	private static final long serialVersionUID = 1L;
    
    public AdminUpdateE_Book() {
        super();
	...
	protected void doALL(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		response.sendRedirect("/admin/include/AdminBook_list.do");
