...
<div style="display:flex;min-height:390px">
	...
	<div style="width:39%;min-height:620px;">
		<div style="text-align:center;padding-top:100px;font-size:30px;font-weight:bold">비밀번호 찾기</div>
		<form action="search_pass.do" method="post">
			<div style="text-align:center;padding-top:100px;">
				<div><input class="inp" name="id" placeholder="아이디"></div>
