...
<div class="writeN-frame">
	<form action="answer_q.do" method="post">
	...
	<div class="writeN-insert">
		<div class="writeN-title">제목 <input id="writeN-titlearea" name="title"></div>
		...
		<div class="writeN-sub"><input id="writeN-sub" type="submit" value="전송"></div>
	</div>
	</form>
</div>
