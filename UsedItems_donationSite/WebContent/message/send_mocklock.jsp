...
String sql="select * from daewha where (my_name='" + session_nickname + "' and my_gu='" + session_kind + "') or(sang_name='" + session_nickname + "' and sang_gu='" + session_kind + "') group by sang_name";
