...
<form name="modify_list" action="mo_guel_update.jsp" method="post" enctype="multipart/form-data">
		...
		<td style="border:1px solid black">
			<table width=100% height=100%>
				...
				<tr>
					<td>
						<br><br><br>
						<img src="/upload/<%=file_rename%>"><br>
						<textarea class="cn_tex" id="content" name="content" placeholder="내용"><%=content%></textarea>
					</td>
				</tr>
				<tr>
					<td>
