...
<div class="modify-container">
    <form name="memModify" method="post">
        ...
        <div class="modify-input">
            <input id="read" name="id" type="text" value="${mvo.id}" readonly="readonly">
        </div>
        <div class="modify-text">
            연 락 처 : 
        </div>
        <div class="modify-input">
            <input type="text" id="tel" name="tel" value="${mvo.tel}">
        </div>
        <div class="modify-text">
            주  소 : 
        </div>
        <div class="modify-input">
            <input type="text" name="address" id="sample6_address"  value="${mvo.address}">
